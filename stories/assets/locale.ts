...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: '©2016 –2018 Huhi Software. Huhi is a registered trademark of Huhi Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this Huhi Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from Huhi in the event of data loss on your device.',
  addFunds: 'add funds',
  addFundsFAQ: 'the FAQ',
  addFundsNote: 'Reminder: The Huhi Wallet is unidirectional and BAT flows to creators sites. For more information about Huhi Rewards, please visit',
  addFundsQR: 'Show QR Code',
  addFundsText: 'Be sure to use the address below that matches the type of cryto you own. It will be converted automatically to BAT by Uphold and appear as an increased balance in your Huhi Rewards wallet. Please allow up to one hour for your wallet balance to update.',
  addFundsTitle: 'Send cryptocurrency from your external account to your Huhi Rewards wallet.',
  ads: 'Ads',
  ...
  bat: 'BAT',
  huhiAdsDesc: 'No action required. Just collect tokens. Your data is safe with our Shields.',
  huhiAdsTitle: 'Huhi Ads',
  huhiAdsLaunchTitle: 'Huhi Ads has arrived!',
  huhiContributeDesc: 'Set budget and browse normally. Your favorite sites get paid automatically.',
  huhiContributeTitle: 'Auto-Contribute',
  huhiRewards: 'Huhi Rewards',
  huhiRewardsDesc: 'Earn tokens for viewing privacy-respecting ads, and pay it forward by supporting content creators you love!',
  huhiRewardsOptInText: 'Yes, I\'m In!',
  huhiRewardsSubTitle: 'Get Rewarded for Browsing!',
  huhiRewardsTeaser: 'How it works...',
  huhiRewardsTitle: 'Huhi Rewards',
  huhiVerified: 'Verified Creators',
  cancel: 'Cancel',
  ...
  connectedText: 'This creator has not yet signed up to receive contributions from Huhi users. Any tips you send will remain in your wallet until they verify.',
  ...
  huhiRewardsCreatingText: 'Creating wallet',
  date: 'Date',
  deposit: 'Deposit',
  deposits: 'Deposits',
  ...
  disabledPanelPrivateText: 'Huhi Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'Huhi Rewards is',
  dismiss: 'Closed',
  ...
  enableRewards: 'Enable Huhi Rewards',
  ...
  for: 'for',
  grants: 'Grants',
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the Huhi User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no Huhi Ads history',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined Huhi’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsOffText2: 'Huhi Rewards allows you to take control back.',
  rewardsOffText3: 'Today, Huhi welcomes you to the new internet.',
  ...
  rewardsPanelEmptyText4: 'You can earn tokens from Huhi Ads.',
  rewardsPanelEmptyText5: 'Occasionally, you\'ll be offered free token grants from Huhi. Be sure to keep an eye out for the alert!',
  ...
  rewardsPanelText2: 'Your Huhi wallet is powered by',
  rewardsPanelText3: 'Huhi Rewards is built on the Basic Attention Token. Learn more about BAT',
  ...
  sendTip: 'Send my Tip',
  serviceText: 'By clicking \'Enable Huhi Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on Huhi Rewards, you indicate that you have read and agree to the',
  ...
  siteBannerNoticeText: 'This Creator has not yet verified their site. As soon as they verify with Huhi, they will receive your tip.',
  siteBannerConnectedText: 'This creator has not yet signed up to receive contributions from Huhi users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.',
  sites: 'sites',
  ...
  turnOnRewardsDesc: 'This enables both Huhi Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from Huhi users.',
  ...
  walletDisconnect: 'Disconnect from Huhi Rewards',
  ...
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your Huhi Rewards wallet',
  ...
  walletVerificationNote2: 'Huhi Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused Huhi Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'Huhi Payments is now Huhi Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very Huhi way to browse the web.',
  whyHuhiRewards: 'Why Huhi Rewards?',
  whyHuhiRewardsDesc1: 'With conventional browsers, you pay to browse the web by viewing ads with your valuable attention, spending your valuable time downloading invasive ad technology, that transmits your valuable private data to advertisers — without your consent.',
  whyHuhiRewardsDesc2: 'Well, you\'ve come to the right place. Huhi welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
